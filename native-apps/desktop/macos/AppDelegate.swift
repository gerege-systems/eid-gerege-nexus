...
public class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupNativeMenuBar() {
        ...
        // 1. App Menu: eID Gerege
        let appMenuItem = NSMenuItem()
        let appMenu = NSMenu(title: "eID Gerege")
        appMenu.addItem(withTitle: "eID Gerege-ийн тухай", action: #selector(aboutApp), keyEquivalent: "")
        ...
        appMenu.addItem(NSMenuItem.separator())
        appMenu.addItem(withTitle: "eID Gerege-ээс гарах", action: #selector(actionQuit), keyEquivalent: "q")
    ...
    @objc private func aboutApp() {
        let alert = NSAlert()
        alert.messageText = "eID Gerege"
        alert.informativeText = "eID Gerege — Gerege Nexus native shell v1.0\nBuilt on Swift 5.10 + AppKit + WKWebView"
