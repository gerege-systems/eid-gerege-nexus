...
///
/// Ажлын муж нь `desktop.eid.gerege.mn` — ширээний domain шугам. Тэр host нь
...
public class MainWindowController: NSWindowController, WKNavigationDelegate, WKUIDelegate, NativeLoginDelegate {
    ...
    private func setupWebView() {
        ...
        webView.customUserAgent = "eIDGeregeMN/1.0 (Macintosh; Intel Mac OS X)"
