...
enum KeychainKey: String {
    case nationalID   = "mn.gerege.eid.desktop.national.id"
    case apiKey       = "mn.gerege.eid.desktop.api.key"
    ...
    case sessionToken = "mn.gerege.eid.desktop.session.token"
    ...
    case identity     = "mn.gerege.eid.desktop.identity"
}
...
final class KeychainManager {
    ...
    private let service = "mn.gerege.eid.desktop"
