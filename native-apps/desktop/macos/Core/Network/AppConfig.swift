...
enum AppConfig {
    ...
    static var brandName: String {
        ...
        return trimmed.isEmpty ? "eID Gerege" : trimmed
    }
    ...
    ///
    /// Платформын backend бүтэн URI-г `EID_APP_CALLBACKS`-аар, eID Mongolia
    /// тухайн RP-ийн `callback_hosts` зөвхөн `gerege-eid://` scheme-ээр шалгана.
    /// Аль нэг нь дутвал ЧИМЭЭГҮЙ хаягдана — app2app буцалт ажиллахгүй байвал
    /// хамгийн түрүүнд энэ хоёр тохиргоог шалгана.
    static let appToAppCallback: String = {
        #if os(iOS)
        return "gerege-eid://auth"
        #else
        return ""
        #endif
    }()
    ...
    static var baseURL: String {
        ...
        // (nginx/device-lines.eid.gerege.mn.conf).
        //
        ...
        // (nginx/device-lines.eid.gerege.mn.conf, snippets/eid-api-proxy.conf).
        //
        // Ингэсний шалтгаан нь гоо сайхан биш: клиент нэг гарал мэддэг бол
        // webview доторх ажлын муж, native дуудлага хоёр НЭГ origin дээр
        // үлдэж, session cookie нь SameSite=Strict хэвээр байна.
        ...
        #if os(iOS)
        return "https://mobile.eid.gerege.mn"
        #else
        return "https://desktop.eid.gerege.mn"
        #endif
    }
