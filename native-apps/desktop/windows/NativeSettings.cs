...
public sealed class NativeSettings
{
    ...
    private static string FilePath => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "eIDGeregeMN", "native-settings-v1.json");
    public static NativeSettings Load()
    {
        ...
        // зөөнө. `https://eid.gerege.mn` энд зориудаар байхгүй — тэр хаяг
