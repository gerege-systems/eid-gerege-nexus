...
using eIDGeregeDesktop.Client.Hosting;
...
namespace eIDGeregeDesktop.Client;
...
public partial class App : Microsoft.UI.Xaml.Application
{
    ...
    protected override void OnLaunched(Microsoft.UI.Xaml.LaunchActivatedEventArgs args)
    {
        ...
        logger.LogInformation("eIDGeregeDesktop.Client starting (version {Version})", AppHost.AssemblyVersion);
