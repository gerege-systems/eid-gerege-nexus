...
using eIDGeregeDesktop.Application;
using eIDGeregeDesktop.Application.Abstractions;
using eIDGeregeDesktop.Client.Navigation;
using eIDGeregeDesktop.Client.Services;
using eIDGeregeDesktop.Infrastructure;
using eIDGeregeDesktop.Infrastructure.Esign;
using eIDGeregeDesktop.Presentation;
using eIDGeregeDesktop.Presentation.Navigation;
...
namespace eIDGeregeDesktop.Client.Hosting;
