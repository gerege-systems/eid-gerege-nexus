...
namespace eIDGeregeDesktop.Infrastructure.Audit;

/// Append-only JSON-lines audit log under %LOCALAPPDATA%/eIDGeregeDesktop/audit/.
...
public sealed class FileAuditLog : IAuditLog
{
    ...
    public FileAuditLog(ILogger<FileAuditLog> logger)
    {
        ...
        LogDirectory = Path.Combine(local, "eIDGeregeDesktop", "audit");
