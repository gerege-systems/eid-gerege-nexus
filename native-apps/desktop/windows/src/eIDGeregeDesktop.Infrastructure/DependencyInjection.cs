...
using eIDGeregeDesktop.Infrastructure.Audit;
using eIDGeregeDesktop.Infrastructure.Auth;
using eIDGeregeDesktop.Infrastructure.Certificates;
using eIDGeregeDesktop.Infrastructure.Dashboard;
using eIDGeregeDesktop.Infrastructure.Esign;
using eIDGeregeDesktop.Infrastructure.Guardian;
using eIDGeregeDesktop.Infrastructure.Health;
using eIDGeregeDesktop.Infrastructure.Http;
using eIDGeregeDesktop.Infrastructure.Org;
using eIDGeregeDesktop.Infrastructure.Security.Hmac;
using eIDGeregeDesktop.Infrastructure.Security.Identity;
using eIDGeregeDesktop.Infrastructure.Security.Idle;
using eIDGeregeDesktop.Infrastructure.Security.Rasp;
using eIDGeregeDesktop.Infrastructure.Security.Tls;
using eIDGeregeDesktop.Infrastructure.Security.Vault;
using eIDGeregeDesktop.Infrastructure.Security.WindowsHello;
using eIDGeregeDesktop.Infrastructure.Time;
using eIDGeregeDesktop.Infrastructure.Tokens;
using eIDGeregeDesktop.Infrastructure.Tokens.Cng;
using eIDGeregeDesktop.Infrastructure.Tokens.Pkcs11;
...
namespace eIDGeregeDesktop.Infrastructure;

public static class DependencyInjection
{
    public const string BackendHttpClientName = "eIDGeregeDesktop.Backend";
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var tokenOpts = configuration
            .GetSection($"{eIDGeregeDesktopOptions.SectionName}:{nameof(eIDGeregeDesktopOptions.Tokens)}")
        ...
        services
            ...
            {
                var opts = sp.GetRequiredService<IOptions<eIDGeregeDesktopOptions>>().Value;
                ...
                client.DefaultRequestHeaders.UserAgent.ParseAdd($"eIDGeregeDesktop-Windows/0.1");
