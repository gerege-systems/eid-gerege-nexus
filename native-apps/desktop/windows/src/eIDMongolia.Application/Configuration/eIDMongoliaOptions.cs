...
namespace eIDMongolia.Application.Configuration;

public sealed class eIDMongoliaOptions
{
    public const string SectionName = "eIDMongolia";
...
public sealed class BackendOptions
{
    ...
    /// (e.g. "Sign in to eIDMongolia desktop"). Max 200 chars.
