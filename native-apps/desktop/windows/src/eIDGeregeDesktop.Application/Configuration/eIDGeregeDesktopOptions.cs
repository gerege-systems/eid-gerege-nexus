...
namespace eIDGeregeDesktop.Application.Configuration;

public sealed class eIDGeregeDesktopOptions
{
    public const string SectionName = "eIDGeregeDesktop";
...
public sealed class BackendOptions
{
    ...
    /// (e.g. "Sign in to eIDGeregeDesktop desktop"). Max 200 chars.
