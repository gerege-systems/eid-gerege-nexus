...
namespace eIDMongolia.Infrastructure.Audit;

/// Append-only JSON-lines audit log under %LOCALAPPDATA%/eIDMongolia/audit/.
...
public sealed class FileAuditLog : IAuditLog
{
    ...
    public FileAuditLog(ILogger<FileAuditLog> logger)
    {
        ...
        LogDirectory = Path.Combine(local, "eIDMongolia", "audit");
