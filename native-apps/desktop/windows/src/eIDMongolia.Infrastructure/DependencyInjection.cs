...
using eIDMongolia.Infrastructure.Audit;
using eIDMongolia.Infrastructure.Auth;
using eIDMongolia.Infrastructure.Certificates;
using eIDMongolia.Infrastructure.Dashboard;
using eIDMongolia.Infrastructure.Esign;
using eIDMongolia.Infrastructure.Guardian;
using eIDMongolia.Infrastructure.Health;
using eIDMongolia.Infrastructure.Http;
using eIDMongolia.Infrastructure.Org;
using eIDMongolia.Infrastructure.Security.Hmac;
using eIDMongolia.Infrastructure.Security.Identity;
using eIDMongolia.Infrastructure.Security.Idle;
using eIDMongolia.Infrastructure.Security.Rasp;
using eIDMongolia.Infrastructure.Security.Tls;
using eIDMongolia.Infrastructure.Security.Vault;
using eIDMongolia.Infrastructure.Security.WindowsHello;
using eIDMongolia.Infrastructure.Time;
using eIDMongolia.Infrastructure.Tokens;
using eIDMongolia.Infrastructure.Tokens.Cng;
using eIDMongolia.Infrastructure.Tokens.Pkcs11;
...
namespace eIDMongolia.Infrastructure;

public static class DependencyInjection
{
    public const string BackendHttpClientName = "eIDMongolia.Backend";
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var tokenOpts = configuration
            .GetSection($"{eIDMongoliaOptions.SectionName}:{nameof(eIDMongoliaOptions.Tokens)}")
        ...
        services
            ...
            {
                var opts = sp.GetRequiredService<IOptions<eIDMongoliaOptions>>().Value;
                ...
                client.DefaultRequestHeaders.UserAgent.ParseAdd($"eIDMongolia-Windows/0.1");
