...
using eIDMongolia.Domain.Tokens;
using eIDMongolia.Presentation.Navigation;
using eIDMongolia.Presentation.Services;

namespace eIDMongolia.Presentation.ViewModels.Pages;
    ...
    bool CanSign)
{
    ...
    public bool IsCertificate => string.Equals(Kind, nameof(eIDMongolia.Domain.Tokens.TokenObjectKind.Certificate), StringComparison.Ordinal);
