...
using eIDMongolia.Application;
using eIDMongolia.Application.Abstractions;
using eIDMongolia.Client.Navigation;
using eIDMongolia.Client.Services;
using eIDMongolia.Infrastructure;
using eIDMongolia.Infrastructure.Esign;
using eIDMongolia.Presentation;
using eIDMongolia.Presentation.Navigation;
using eIDMongolia.Presentation.Services;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Serilog;

namespace eIDMongolia.Client.Hosting;
