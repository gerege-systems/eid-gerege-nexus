...
using eIDGeregeDesktop.Domain.Tokens;
using eIDGeregeDesktop.Presentation.Navigation;
using eIDGeregeDesktop.Presentation.Services;

namespace eIDGeregeDesktop.Presentation.ViewModels.Pages;
    ...
    bool CanSign)
{
    ...
    public bool IsCertificate => string.Equals(Kind, nameof(eIDGeregeDesktop.Domain.Tokens.TokenObjectKind.Certificate), StringComparison.Ordinal);
