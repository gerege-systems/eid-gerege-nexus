...
struct MobileLoginView: View {
    ...
    private func beginBackgroundTask() {
        endBackgroundTask()
        backgroundTaskID = UIApplication.shared.beginBackgroundTask(withName: "mn.gerege.eid.eid_poll") {
    ...
    private func handleCallbackURL(_ url: URL) {
        guard url.scheme == "gerege-eid" || url.scheme == "gerege-nexus" else { return }
